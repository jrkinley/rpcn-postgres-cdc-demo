...
docker logs -f redpanda-connect
```
...
```bash
INSERT INTO quotes VALUES (default, 'AAPL', '2024-12-06', '$000.00', 36870620, '$242.905', '$244.63', '$242.08');
SELECT * FROM quotes WHERE symbol = 'AAPL' ORDER BY date DESC LIMIT 5;

  id  | symbol |    date    |  close  |  volume  |   open   |  high   |   low
------+--------+------------+---------+----------+----------+---------+---------
 7549 | AAPL   | 2024-12-06 | $000.00 | 36870620 | $242.905 | $244.63 | $242.08
    1 | AAPL   | 2024-12-05 | $243.04 | 40033880 | $243.99  | $244.54 | $242.13
    2 | AAPL   | 2024-12-04 | $243.01 | 44383940 | $242.87  | $244.11 | $241.25
    3 | AAPL   | 2024-12-03 | $242.65 | 38861020 | $239.81  | $242.76 | $238.90
    4 | AAPL   | 2024-12-02 | $239.59 | 48137100 | $237.27  | $240.79 | $237.16
...
```bash
rpk topic consume quotes_AAPL -o -2 -n 2 --use-schema-registry

{
  "topic": "quotes_AAPL",
  "value": "{\"open\":\"$242.905\",\"high\":\"$244.63\",\"low\":\"$242.08\",\"id\":7549,\"symbol\":\"AAPL\",\"date\":\"2024-12-06T00:00:00Z\",\"close\":\"$000.00\",\"volume\":36870620}",
  "timestamp": 1748518656216,
  "partition": 0,
  "offset": 2516
}
{
  "topic": "quotes_AAPL",
  "value": "{\"symbol\":\"AAPL\",\"date\":\"2024-12-06T00:00:00Z\",\"close\":\"$242.84\",\"volume\":36870620,\"open\":\"$242.905\",\"high\":\"$244.63\",\"low\":\"$242.08\",\"id\":7549}",
  "timestamp": 1748518691076,
  "partition": 0,
  "offset": 2517
}
```
